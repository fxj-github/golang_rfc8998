...
TEXT ·sm2NegCond(SB),NOSPLIT,$0
	...
	// acc = poly
	MOVD	$-1, acc0
	MOVD	sm2const0<>(SB), acc1
	MOVD	$-1, acc2
	MOVD	sm2const1<>(SB), acc3
...
TEXT ·sm2Sqr(SB),NOSPLIT,$0
	...
	MOVD	sm2const0<>(SB), const0
	MOVD	sm2const1<>(SB), const1
	MOVD	$-1, const4
...
TEXT ·sm2OrdSqr(SB),NOSPLIT,$0
	...
	MOVD	sm2ordK0<>(SB), hlp1
	LDP	sm2ord<>+0x00(SB), (const0, const1)
	LDP	sm2ord<>+0x10(SB), (const2, const3)
...
TEXT ·sm2PointAddAffineAsm(SB),0,$264-48
	MOVD	in1+8(FP), a_ptr
	MOVD	in2+16(FP), b_ptr
	...
	CSEL	EQ, acc2, y2, y2
	CSEL	EQ, acc3, y3, y3
	LDP	sm2one<>+0x00(SB), (acc0, acc1)
	LDP	sm2one<>+0x10(SB), (acc2, acc3)
...
TEXT ·sm2PointDoubleAsm(SB),NOSPLIT,$136-16
	MOVD	res+0(FP), res_ptr
	MOVD	in+8(FP), a_ptr
...
TEXT ·sm2PointAddAsm(SB),0,$392-32
	...
	MOVD	$1, t2
	ORR	x0, x1, t0             // Check if zero mod sm2
	ORR	x2, x3, t1
	ORR	t1, t0, t0
	CMP	$0, t0
	CSEL	EQ, t2, ZR, hlp1
